...
BACKGROUND_COLOR_DICT = {2: "#eee4da", 4: "#ede0c8", 8: "#f2b179", 16: "#f59563", 32: "#f67c5f", 64: "#f65e3b",
                         ...
                         512: "#edc850", 1024: "#edc53f", 2048: "#edc22e", 4096: "#f65e79", 8192: "#f65e79",
                         16384: "#f65e79", 32768: "#f65e79", 65536: "#f65e79"}
CELL_COLOR_DICT = {2: "#776e65", 4: "#776e65", 8: "#f9f6f2", 16: "#f9f6f2", 32: "#f9f6f2", 64: "#f9f6f2",
                   128: "#f9f6f2", 256: "#f9f6f2",
                   512: "#f9f6f2", 1024: "#f9f6f2", 2048: "#f9f6f2", 4096: "#f9f6f2", 8192: "#f9f6f2", 16384: "#f9f6f2",
...
class GameGrid(Frame):
    ...
    def key_down(self, event):
        ...
        if key in self.commands:
            self.matrix, done, score_change = self.commands[repr(event.char)](self.matrix)
